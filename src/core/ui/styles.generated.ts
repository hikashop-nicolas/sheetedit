...
.sheetedit-table td.has-rot .sheetedit-cellrot > span { white-space:pre; display:inline-block; }
...
.sheetedit-nogrid .sheetedit-table td { box-shadow:none; }
.sheetedit-table th {
...
.sheetedit-table th.rownum { position:sticky; left:0; z-index:5; top:auto; text-align:right; background:var(--sheetedit-head-bg); padding:0; overflow:hidden; }
.sheetedit-rownum-label { position:absolute; inset:0; display:flex; align-items:center; justify-content:flex-end; padding:0 8px; }
...
.sheetedit-table td.va-top > input { bottom:auto; height:auto; padding:2px 8px; }
.sheetedit-table td.va-bottom > input { top:auto; height:auto; padding:2px 8px; }
...
.sheetedit-table td { position:relative; }
.sheetedit-table input {
position:absolute; inset:0; border:0; background:transparent; color:var(--sheetedit-cell-fg);
font:inherit; padding:0 8px; box-sizing:border-box; outline:none;
}
...
.sheetedit-ctrl-grid {
width:100%; height:100%; box-sizing:border-box; overflow:auto; border-radius:3px;
background:var(--sheetedit-cell-bg); color:var(--sheetedit-cell-fg); border:1px solid var(--sheetedit-head-border);
}
.sheetedit-ctrl-gridrow { display:grid; gap:0 8px; padding:1px 4px; cursor:pointer; white-space:nowrap; }
.sheetedit-ctrl-gridrow > span { overflow:hidden; text-overflow:ellipsis; }
.sheetedit-ctrl-gridrow:hover { background:var(--sheetedit-head-hover); }
.sheetedit-ctrl-gridrow.chosen { background:var(--sheetedit-accent); color:var(--sheetedit-accent-fg); }
...
.sheetedit-vba-list { display:flex; flex-wrap:wrap; gap:4px; margin-bottom:10px; }
.sheetedit-vba-mod {
font:inherit; font-size:12px; padding:3px 9px; border-radius:5px; cursor:pointer;
background:var(--sheetedit-btn); color:var(--sheetedit-text); border:1px solid var(--sheetedit-btn-border);
}
...
display: flex; gap: 2px; pointer-events: none; z-index: 3; max-width: 100%;
}
.sheetedit-peerflag {
