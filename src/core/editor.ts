...
import { setOdsAutoFilter, setOdsCellNumFmt, setOdsCellStyle, setOdsColWidth, setOdsComment, setOdsCondFormat, setOdsDataValidation, setOdsHyperlink, setOdsMerge, setOdsRowHeight, setOdsSparkline, setOdsSparklineGroup } from "../adapters/ods";
...
import { formDialog as uiFormDialog, type FormField } from "./ui/form-dialog";
...
import { deleteXlsxShape, flagXlsxPivotRefresh, setXlsxAutoFilter, setXlsxCellNumFmt, setXlsxCellStyle, setXlsxColWidth, setXlsxComment, setXlsxCondFormat, setXlsxDataValidation, setXlsxHyperlink, setXlsxMerge, setXlsxRowHeight, setXlsxRowHidden, setXlsxSparkline, setXlsxSparklineGroup } from "../adapters/xlsx";
// ---------------------------------------------------------------------------
// Editor
// ---------------------------------------------------------------------------
...
export function createSheetEditor(
  ...
  const formDialog = (title: string, fields: FormField[], onOk: (vals: Record<string, string | boolean>) => void): void => uiFormDialog(wrap, title, fields, onOk);
  ...
  const openCfDialog = (): void => {
    ...
    formDialog(t("cfEdit"), [
      ...
      let spec: import("../adapters/xlsx/write").CfSpec;
